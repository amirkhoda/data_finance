  ...
  return (
    <div className='max-w-[1240] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
        <div>
            ...
            <p className='py-4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sequi quae ducimus est? Dolores excepturi quo exercitationem quidem at perspiciatis odio.</p>
